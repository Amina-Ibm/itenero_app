...
class TripUpdateTable extends _i1.UpdateTable<TripTable> {
  ...
  _i1.ColumnValue<String, String> destination(String value) => _i1.ColumnValue(
    table.destination,
    value,
  );
  ...
  _i1.ColumnValue<String, String> travelersType(String value) =>
      _i1.ColumnValue(
        table.travelersType,
        value,
      );
...
class TripTable extends _i1.Table<int?> {
  TripTable({super.tableRelation}) : super(tableName: 'trip') {
    ...
    travelersType = _i1.ColumnString(
      'travelersType',
      this,
    );
  ...
  late final _i1.ColumnString travelersType;
